...
namespace aya.Node
{
    public class Case : Statement
    {
        ...
        public CaseSubcondition NewSubcondition(BigNumber num)
        {
            return new SubcondNumeric(num);
        }

        public CaseSubcondition NewSubcondition(BigNumber lower, BigNumber higher)
        {
        ...
        public class SubcondNumeric : CaseSubcondition
        {
            ...
            public SubcondNumeric(BigNumber num)
            {
                this.num = num;
            }
            ...
            public override bool Match(Value attention)
            {
                ...
                {
                    return num == attention.GetBigNumber();
                }
                else
                {
                    return false;
        ...
        {
            private BigNumber lower, higher;

            public SubcondNumericRange(BigNumber lower, BigNumber higher)
            {
                this.lower = lower;
                this.higher = higher;
            }
            ...
            public override bool Match(Value attention)
            {
                if (attention.IsNumeric())
                {
                    BigNumber n = attention.GetBigNumber();
